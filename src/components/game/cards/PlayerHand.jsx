...
const PlayerHand = ({ cards }) => {
  ...
  useEffect(() => {
    const shouldUpdate = (currentState, newState) =>
      newState === "none" || currentState !== "back";
  ...
  const flipOrThrow = async (e, currentState, setNextState, baseState) => {
    const canPlay =
      intel.last.currentPlayerUuid === uuid &&
      intel.last.possibleActions.includes("PLAY");
  ...
  return (
    <div className="player-hand">
      ...
      <div
        ...
        onClick={(e) => flipOrThrow(e, left, setLeft, cards[0])}
      >
        <Card name={left} />
      </div>
      ...
      <div
        ...
        onClick={(e) => flipOrThrow(e, center, setCenter, cards[1])}
      >
        <Card name={center} />
      </div>
      ...
      <div
        ...
        onClick={(e) => flipOrThrow(e, right, setRight, cards[2])}
      >
        <Card name={right} />
      </div>
